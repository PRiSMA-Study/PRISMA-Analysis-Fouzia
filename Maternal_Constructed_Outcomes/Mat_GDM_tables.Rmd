  ...
  summarise(
    ...
    "Missing MNH08 Enrollment form, n (%)" = 
      paste0(sum(M08_MAT_VISIT_FORM_COMPLETED_1==0),
             " (",
             format(round(sum(M08_MAT_VISIT_FORM_COMPLETED_1==0)/n()*100, 2),nsmall=2, digits=3),
             ")"),
    # HBA1C IS MEASURED AT ENROLLMENT
    "Missing HbA1c: M08_HBA1C_PRCNT_1, n (%)" =
      paste0(sum(is.na(M08_HBA1C_PRCNT_1), (M08_HBA1C_PRCNT_1==-5), (M08_HBA1C_PRCNT_1==-7)),
             " (",
             format(round(sum(is.na(M08_HBA1C_PRCNT_1), 
                              (M08_HBA1C_PRCNT_1==-5), 
                              (M08_HBA1C_PRCNT_1==-7))/n()*100, 2),nsmall=2, digits=3),
             ")"),
    
    "Missing MNH08 form at ANC28, n (%)" = 
      paste0(sum(M08_MAT_VISIT_FORM_COMPLETED_3==0),
             " (",
             format(round(sum(M08_MAT_VISIT_FORM_COMPLETED_3==0)/n()*100, 2),nsmall=2, digits=3),
             ")"),
    ...
    "Missing ANC28 Pretest Fasting Glucose: M08_BGLUC_PRETEST_MMOLL_LBORRES_3, n (%)" =
      paste0(sum(is.na(M08_BGLUC_PRETEST_MMOLL_LBORRES_3), 
             ...
             format(round(sum(is.na(M08_BGLUC_PRETEST_MMOLL_LBORRES_3), 
                              (M08_BGLUC_PRETEST_MMOLL_LBORRES_3==-5),
                              (M08_BGLUC_PRETEST_MMOLL_LBORRES_3==-7))/n()*100, 2),nsmall=2, digits=3),
             ")"),
    ...
    "Missing ANC28 1-hr OGTT: M08_BGLUC_ORAL_1HR_MMOLL_LBORRES_3, n (%)" =
      paste0(sum(is.na(M08_BGLUC_ORAL_1HR_MMOLL_LBORRES_3), 
             ...
             format(round(sum(is.na(M08_BGLUC_ORAL_1HR_MMOLL_LBORRES_3), 
                              (M08_BGLUC_ORAL_1HR_MMOLL_LBORRES_3==-7),
                              (M08_BGLUC_ORAL_1HR_MMOLL_LBORRES_3==-5))/n()*100, 2),nsmall=2, digits=3),
             ")"),
    ...
    " Missing ANC28 2-hr OGTT: M08_BGLUC_ORAL_2HR_MMOLL_LBORRES_3, n (%)" =
      paste0(sum(is.na(M08_BGLUC_ORAL_2HR_MMOLL_LBORRES_3), 
             ...
             format(round(sum(is.na(M08_BGLUC_ORAL_2HR_MMOLL_LBORRES_3),
                              (M08_BGLUC_ORAL_2HR_MMOLL_LBORRES_3==-5),
                              (M08_BGLUC_ORAL_2HR_MMOLL_LBORRES_3==-7))/n()*100, 2),nsmall=2, digits=3),
             ")")) %>%
...
diabetes_table  %>% 
  `rownames<-` (c(
    "Missing MNH08 Enrollment form, n (%)",
    "Missing Enrollment HbA1c: M08_HBA1C_PRCNT_1, n (%)",
    "Missing MNH08 form at ANC28, n (%)",
    "Missing ANC28 Pretest Fasting Glucose: M08_BGLUC_PRETEST_MMOLL_LBORRES_3, n (%)",
    "Missing ANC28 1-hr OGTT: M08_BGLUC_ORAL_1HR_MMOLL_LBORRES_3, n (%)",
    "Missing ANC28 2-hr OGTT: M08_BGLUC_ORAL_2HR_MMOLL_LBORRES_3, n (%)")) %>% 
...
diabetes_table  %>% 
  ...
  pack_rows("Overt Diabetes (HbA1c)  Category, n (%)", 1, 3, label_row_css = "color: steelblue;") %>%
  pack_rows("Fasting Glucose [BGLUC_PRETEST_MMOLL_LBORRES], n (%)", 4, 6, label_row_css = "color: steelblue;") %>%
  pack_rows("OGTT 1-hr [BGLUC_ORAL_1HR_MMOLL_LBORRES], n (%)", 7, 9, label_row_css = "color: steelblue;") %>%
  pack_rows("OGTT 2-hr [BGLUC_ORAL_2HR_MMOLL_LBORRES], n (%)", 10, 12, label_row_css = "color: steelblue;")
...
hba1c_nomissing <- df %>% filter(!is.na(M08_HBA1C_PRCNT_1))
...
fasting_gluc_nomissing <- df %>% filter(!is.na(M08_BGLUC_PRETEST_MMOLL_LBORRES_3))
