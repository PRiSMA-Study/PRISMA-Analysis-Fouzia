  ...
  summarise(
    ...
    "Missing MNH08 Enrollment form^a^, n (%)" = 
      paste0(sum(M08_MAT_VISIT_FORM_COMPLETED_1==0),
             " (",
             format(round(sum(M08_MAT_VISIT_FORM_COMPLETED_1==0)/sum((ENROLL_PASS==1))*100, 2),nsmall=2, digits=3), # this ALREADY INCLUDES WINDOW HAS PASSED B/C I HAVE SUBSUTTED TO ANC28 WINDOW PASS==1.  COULD ALSO HAVE DONE USING OVERDUE==1.  AND THEN I WOULD DIVIDE BY everyone who is passed the window. 
             ")"),
    ...
    "Missing MNH08 form at ANC28^c^, n (%)" = 
      paste0(sum(M08_MAT_VISIT_FORM_COMPLETED_3==0),
             " (",
             format(round(sum(M08_MAT_VISIT_FORM_COMPLETED_3==0)/(sum(ANC28_PASS==1))*100, 2),nsmall=2, digits=3), # this is missing the ANC28 form out of everyone who has passed ANC28
             ")"),
...
```
^a^Among those who have a GA>=20 (passed their enrollment) among women who have Hba1c <6.5 (Fix this to all women who are missing MNH08 enrollment)
<br>
^b^Among those who have a GA>=20 (passed their enrollment) and have completed MNH08 enrollment form
<br>
^c^Among those who have a GA>30 (passed their ANC28 window)
<br>
^d^Among those who have a GA>30 (passed their ANC28 window) and have completed MNH08 ANC-28
<br>
