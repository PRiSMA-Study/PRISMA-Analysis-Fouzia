...
temp.df %>% summarize(n())
write.csv(missing_mnh08_diab_df, '../data_out/missing_mnh08_df_diab_20231017.csv')
```
...
############
temp.df <- diabetes_df3 %>% 
  select(MOMID, SITE, M08_HBA1C_PRCNT_1, M08_BGLUC_PRETEST_MMOLL_LBORRES_3, 
...
temp.df <- diabetes_df %>% select(MOMID, SITE, M08_BGLUC_PRETEST_MMOLL_LBORRES_3, M08_BGLUC_ORAL_1HR_MMOLL_LBORRES_3, M08_BGLUC_ORAL_2HR_MMOLL_LBORRES_3)
...
write.csv(diabetes_df, '../data_out/mat_diabetes_fortables_20231017.csv') # restricted to women who have a visit 3. 
```
