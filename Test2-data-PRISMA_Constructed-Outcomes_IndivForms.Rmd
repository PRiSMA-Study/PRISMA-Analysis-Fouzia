...
table(GEST_HYPER_DIAG = mnh_merged_df$GEST_HYPER_DIAG, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(SEVERE_GEST_HYPER_REP = case_when(M09_HDP_HTN_MHOCCUR_3_6==1 & M09_PREECLAMPSIA_CEOCCUR_3_6==1 ~ 1,
                                           M19_HDP_HTN_MHOCCUR_3_13==1 & M19_PREECLAMPSIA_CEOCCUR_3_13==1 ~ 1,
                                           TRUE ~ as.numeric(0)))
table(SEVERE_GEST_HYPER_REP = mnh_merged_df$SEVERE_GEST_HYPER_REP, useNA = "always")
```
...
table(GEST_DIAB_DIAG = mnh_merged_df$GEST_DIAB_DIAG, useNA = "always")
table(GEST_DIAB_MEAS = mnh_merged_df$GEST_DIAB_MEAS, useNA = "always")
...
table(MAT_APH = temp.df$MAT_APH, useNA = "always")
```
...
table(MAT_PPH_LATE = mnh_merged_df$MAT_PPH_LATE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_INFECT_DIAG_ANC = case_when(M04_HIV_CMOCCUR_1==1 | M04_HIV_CMOCCUR_2==1 | M04_HIV_CMOCCUR_3==1 | 
                                         ...
                                         TRUE ~ as.numeric(0)))
table(MAT_INFECT_DIAG_ANC = mnh_merged_df$MAT_INFECT_DIAG_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_INFECT_SEPSIS_DIAG_ANC = case_when(MAT_DYS==1 & MAT_INFECT_DIAG_ANC==1 ~ 1, 
                                         TRUE ~ as.numeric(0)))
table(mnh_merged_df$MAT_INFECT_SEPSIS_DIAG_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_SYPH_INFECT_TREAT_ANC = case_when(M04_SYPH_CMTRT_1_1==1 | M04_SYPH_CMTRT_1_2==1 | M04_SYPH_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_SYPH_INFECT_TREAT_ANC = mnh_merged_df$MAT_SYPH_INFECT_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_GONORRHEA_INFECT_TREAT_ANC = case_when(M04_GONORRHEA_CMTRT_1_1==1 | M04_GONORRHEA_CMTRT_1_2==1 | M04_GONORRHEA_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_GONORRHEA_INFECT_TREAT_ANC = mnh_merged_df$MAT_GONORRHEA_INFECT_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_CHLAMYDIA_INFECT_TREAT_ANC = case_when(M04_CHLAMYDIA_CMTRT_1_1==1 | M04_CHLAMYDIA_CMTRT_1_2==1 | M04_CHLAMYDIA_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_CHLAMYDIA_INFECT_TREAT_ANC = mnh_merged_df$MAT_CHLAMYDIA_INFECT_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_CHANC_INFECT_TREAT_ANC = case_when(M04_CHANC_CMTRT_1_1==1 | M04_CHANC_CMTRT_1_2==1 | M04_CHANC_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_CHANC_INFECT_TREAT_ANC = mnh_merged_df$MAT_CHANC_INFECT_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_STI_OTHR_INFECT_TREAT_ANC = case_when(M04_STI_OTHR_CMOCCUR_1==1 | M04_STI_OTHR_CMOCCUR_2==1 | M04_STI_OTHR_CMOCCUR_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_STI_OTHR_INFECT_TREAT_ANC = mnh_merged_df$MAT_STI_OTHR_INFECT_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_MALARIA_INFECT_TREAT_ANC = case_when(M04_MALARIA_EVER_CMTRT_1_1==1 | M04_MALARIA_EVER_CMTRT_1_2==1 | M04_MALARIA_EVER_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_MALARIA_INFECT_TREAT_ANC = mnh_merged_df$MAT_MALARIA_INFECT_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_TB_INFECT_TREAT_ANC = case_when(M04_TB_CMTRT_1_1==1 | M04_TB_CMTRT_1_2==1 | M04_TB_CMTRT_1_3==1 | 
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_TB_INFECT_TREAT_ANC = mnh_merged_df$MAT_TB_INFECT_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_ANTIBX_TREAT_ANC = case_when(M04_ANTIBX_CMOCCUR_1==1 | M04_ANTIBX_CMOCCUR_2==1 | M04_ANTIBX_CMOCCUR_3==1 |
                                          ...
                                          TRUE ~ as.numeric(0)))
table(MAT_ANTIBX_TREAT_ANC = mnh_merged_df$MAT_ANTIBX_TREAT_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%  # POC FIRST (MNH06)
  mutate(MAT_INFECT_MEAS_POC_LAB_ANC = case_when((M06_HIV_POC_LBORRES_1==1 | M06_HIV_POC_LBORRES_2==1 | M06_HIV_POC_LBORRES_3==1 | 
                                                   ...
                                                   M06_COVID_POC_LBORRES_4==1 | M06_COVID_POC_LBORRES_5==1 | M06_COVID_POC_LBORRES_13==1) ~ 1, 
                                                 ...
                                                 TRUE ~ as.numeric(0)))
table(MAT_INFECT_MEAS_POC_LAB_ANC = mnh_merged_df$MAT_INFECT_MEAS_POC_LAB_ANC, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_INFECT_DIAG_IPC_POST_DELIV = case_when((M09_COMMUNIC_MHOCCUR_1_6==1 | M09_COMMUNIC_MHOCCUR_2_6==1 | M09_COMMUNIC_MHOCCUR_3_6==1 | 
                                         ...
                                         TRUE ~ as.numeric(0)))
table(MAT_INFECT_DIAG_IPC_POST_DELIV = mnh_merged_df$MAT_INFECT_DIAG_IPC_POST_DELIV, useNA = "always")
...
table(MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV = mnh_merged_df$MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV, useNA = "always")
```
