...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(PRETERM_SPON = ifelse((!is.na(M09_PTB_MHOCCUR_6) & M09_PTB_MHOCCUR_6==1 | !is.na(M09_PTB_MHSTDAT_6)) &
                               ...
                               1,0))
table(mnh_merged_df$PRETERM_SPON, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(PRETERM_PROV = ifelse((!is.na(M09_PTB_MHOCCUR_6) & M09_PTB_MHOCCUR_6==1 | !is.na(M09_PTB_MHSTDAT_6)) |
                               ...
                               1,0))
table(mnh_merged_df$PRETERM_PROV, useNA = "always")
...
table(mnh_merged_df$PPROM_OCCUR, useNA = "always")

#***any_PTB** #
mnh_merged_df <- mnh_merged_df %>% 
  mutate(PRETERM_ANY = ifelse(PRETERM_SPON==1 | PRETERM_PROV==1, 1,0))

table(mnh_merged_df$PRETERM_ANY, useNA = "always")
```
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(GEST_HYPER_MEAS = case_when(CHRON_HYPER==0 & ((((meanSBP_ANC20 >=140 | meanDBP_ANC20 >=90) &
                                     ...
                                     TRUE  ~ as.numeric(0)))
table(mnh_merged_df$GEST_HYPER_MEAS, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(SEVERE_GEST_HYPER = case_when(CHRON_HYPER==0 &((meanSBP_ANC20 >=160 | meanDBP_ANC20 >=110 |
                                     ...
                                     TRUE  ~ as.numeric(0)))
table(mnh_merged_df$SEVERE_GEST_HYPER, useNA = "always")
...
table(mnh_merged_df$PROTEINURIA)
```
...
table(temp.df$GEST_DIAB_MEAS, useNA = "always")
...
table(temp.df$MAT_APH, useNA = "always")
```
...
table(temp.df$MAT_PPH, useNA = "always")
