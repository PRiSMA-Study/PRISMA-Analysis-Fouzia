...
Create a SITE variable for Test data only on Mac. 
```{r}

# mnh_list[["mnh00"]] <- append(mnh_list[["mnh00"]], "SITE", after = 2)
# 
# for(i in 1:names(mnh_list)) {
#   mnh_list[[i]] <- append(mnh_list[[i]], "SITE", after = 2)
# }
# 
# sort(colnames(mnh_list[["mnh00"]]))
```
