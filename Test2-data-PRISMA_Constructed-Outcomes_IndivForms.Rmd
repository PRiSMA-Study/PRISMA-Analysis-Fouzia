...
table(mnh_merged_df$MAT_ANEMIA_MEAS1, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_ANEMIA_MEAS_ANY = ifelse((MAT_ANEMIA_MEAS1 == "mild" |  MAT_ANEMIA_MEAS2 == "mild" | MAT_ANEMIA_MEAS3 == "mild" |
                                         ...
                                         MAT_ANEMIA_MEAS7 == "mild" | MAT_ANEMIA_MEAS8 == "mild" | MAT_ANEMIA_MEAS9 == "mild"), "mild",
                                      ...
                                      ifelse((MAT_ANEMIA_MEAS1 == "moderate" |  MAT_ANEMIA_MEAS2 == "moderate" | MAT_ANEMIA_MEAS3 == "moderate" |
                                                ...
                                                MAT_ANEMIA_MEAS7 == "moderate" | MAT_ANEMIA_MEAS8 == "moderate" | MAT_ANEMIA_MEAS9 == "moderate"), "moderate",
                                             ...
                                             ifelse((MAT_ANEMIA_MEAS1 == "severe" |  MAT_ANEMIA_MEAS2 == "severe" | MAT_ANEMIA_MEAS3 == "severe" |
                                                       ...
                                                       MAT_ANEMIA_MEAS7 == "severe" | MAT_ANEMIA_MEAS8 == "severe" | MAT_ANEMIA_MEAS9 == "severe"), "severe",
...
table(mnh_merged_df$MAT_ANEMIA_MEAS_ANY, useNA = "always")
```
