...
temp.df <- mnh_merged_df %>% select(MOMID, PREGID, PREG_DEATH_DIFF_DAYS,
                                    M23_DTHDAT, 
...
mnh_merged_df <- mnh_merged_df %>% 
  ...
  mutate(LATE_PREG_DEATH = if_else(M23_CLOSE_DSDECOD == 3 | !is.na(M23_DTHDAT) | M10_MAT_DSTERM_6==3, 
                              if_else(var_w_deliverydate, # THIS IS A TRUE/FALSE.
                                      ((as.numeric(as.Date(M23_DTHDAT) - as.Date(max(M09_DELIV_DSSTDAT_INF1_6,
                                                                          M09_DELIV_DSSTDAT_INF2_6, 
                                                                          M09_DELIV_DSSTDAT_INF3_6,
                                                                          M09_DELIV_DSSTDAT_INF4_6, 
                                        ...
                                        (as.numeric(as.Date(M23_DTHDAT) - as.Date(max(M09_DELIV_DSSTDAT_INF1_6,
                                                                          ...
                                                                          M09_DELIV_DSSTDAT_INF4_6, 
                                                                          na.rm = TRUE)) <
                                                   as.difftime(366, units = "days")))),
                                      1), 
                              0)) %>% 
  mutate(LATE_PREG_DEATH = if_else(M23_CLOSE_DSDECOD==4 | M23_CLOSE_DSDECOD==5, 9, LATE_PREG_DEATH))
...
# 1. M09_PPH_CEOCCUR_6 == 0 for many where M09_PPH_ESTIMATE_FAORRES_6 >=500 - #
