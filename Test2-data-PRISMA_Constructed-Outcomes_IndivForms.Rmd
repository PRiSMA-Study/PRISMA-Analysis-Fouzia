...
M19_PRIMARY_MHTERM_14 <- ifelse("M19_PRIMARY_MHTERM_14" %in% names(merged_df),
                                            merged_df$M19_PRIMARY_MHTERM_14, NA)

M19_INFECTION_MHTERM_1_14 <- ifelse("M19_INFECTION_MHTERM_1_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_1_14, NA)

M19_INFECTION_MHTERM_2_14 <- ifelse("M19_INFECTION_MHTERM_2_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_2_14, NA)

M19_INFECTION_MHTERM_3_14 <- ifelse("M19_INFECTION_MHTERM_3_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_3_14, NA)

M19_INFECTION_MHTERM_4_14 <- ifelse("M19_INFECTION_MHTERM_4_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_4_14, NA)

M19_INFECTION_MHTERM_5_14 <- ifelse("M19_INFECTION_MHTERM_5_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_5_14, NA)

M19_INFECTION_MHTERM_6_14 <- ifelse("M19_INFECTION_MHTERM_6_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_6_14, NA)

M19_INFECTION_MHTERM_7_14 <- ifelse("M19_INFECTION_MHTERM_7_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_7_14, NA)

M19_INFECTION_MHTERM_8_14 <- ifelse("M19_INFECTION_MHTERM_8_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_8_14, NA)

M19_INFECTION_MHTERM_9_14 <- ifelse("M19_INFECTION_MHTERM_9_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_9_14, NA)

M19_INFECTION_MHTERM_10_14 <- ifelse("M19_INFECTION_MHTERM_10_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_10_14, NA)

M19_INFECTION_MHTERM_11_14 <- ifelse("M19_INFECTION_MHTERM_11_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_11_14, NA)

M19_INFECTION_MHTERM_12_14 <- ifelse("M19_INFECTION_MHTERM_12_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_12_14, NA) # MATERNAL SEPSIS

M19_INFECTION_MHTERM_13_14 <- ifelse("M19_INFECTION_MHTERM_13_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_13_14, NA)

M19_INFECTION_MHTERM_14_14 <- ifelse("M19_INFECTION_MHTERM_14_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_14_14, NA)

M19_INFECTION_MHTERM_15_14 <- ifelse("M19_INFECTION_MHTERM_15_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_15_14, NA)

M19_INFECTION_MHTERM_16_14 <- ifelse("M19_INFECTION_MHTERM_16_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_16_14, NA)

M19_INFECTION_MHTERM_17_14 <- ifelse("M19_INFECTION_MHTERM_17_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_17_14, NA)

M19_INFECTION_MHTERM_18_14 <- ifelse("M19_INFECTION_MHTERM_18_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_18_14, NA)

M19_INFECTION_MHTERM_19_14 <- ifelse("M19_INFECTION_MHTERM_19_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_19_14, NA)

M19_INFECTION_MHTERM_88_14 <- ifelse("M19_INFECTION_MHTERM_88_14" %in% names(merged_df),
                                            merged_df$M19_INFECTION_MHTERM_88_14, NA)

M19_ABX_CMOCCUR_14 <- ifelse("M19_ABX_CMOCCUR_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMOCCUR_14, NA)

M19_ABX_CMTRT_1_14 <- ifelse("M19_ABX_CMTRT_1_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_1_14, NA)

M19_ABX_CMTRT_2_14 <- ifelse("M19_ABX_CMTRT_2_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_2_14, NA)

M19_ABX_CMTRT_3_14 <- ifelse("M19_ABX_CMTRT_3_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_3_14, NA)

M19_ABX_CMTRT_4_14 <- ifelse("M19_ABX_CMTRT_4_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_4_14, NA)

M19_ABX_CMTRT_5_14 <- ifelse("M19_ABX_CMTRT_5_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_5_14, NA)

M19_ABX_CMTRT_6_14 <- ifelse("M19_ABX_CMTRT_6_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_6_14, NA)

M19_ABX_CMTRT_7_14 <- ifelse("M19_ABX_CMTRT_7_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_7_14, NA)

M19_ABX_CMTRT_8_14 <- ifelse("M19_ABX_CMTRT_8_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_8_14, NA)

M19_ABX_CMTRT_9_14 <- ifelse("M19_ABX_CMTRT_9_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_9_14, NA)

M19_ABX_CMTRT_88_14 <- ifelse("M19_ABX_CMTRT_88_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMTRT_88_14, NA)

M19_ABX_CMINDC_14 <- ifelse("M19_ABX_CMINDC_14" %in% names(merged_df),
                                            merged_df$M19_ABX_CMINDC_14, NA)

# MATERNAL HOSPITALIZATION DURING PNC (_14) - ORGAN DYSFUNCTION AND SEPSIS

M19_PRIMARY_MHTERM_1 <- ifelse("M19_PRIMARY_MHTERM_1" %in% names(merged_df),
                                            merged_df$M19_PRIMARY_MHTERM_1, NA)

M19_ORGAN_FAIL_MHTERM_1_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_1_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_1_14, NA)

M19_ORGAN_FAIL_MHTERM_2_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_2_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_2_14, NA)

M19_ORGAN_FAIL_MHTERM_3_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_3_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_3_14, NA)

M19_ORGAN_FAIL_MHTERM_4_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_4_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_4_14, NA)

M19_ORGAN_FAIL_MHTERM_5_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_5_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_5_14, NA)

M19_ORGAN_FAIL_MHTERM_6_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_6_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_6_14, NA)

M19_ORGAN_FAIL_MHTERM_7_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_7_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_7_14, NA)

M19_ORGAN_FAIL_MHTERM_88_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_88_14" %in% names(merged_df),
                                            merged_df$M19_ORGAN_FAIL_MHTERM_88_14, NA)

M19_ORGAN_FAIL_MHTERM_99_14 <- ifelse("M19_ORGAN_FAIL_MHTERM_99_14" %in% names(merged_df),
...
```{r}
# merged_df <- merged_df %>%
#   mutate(MAT_PE_SEV_MEASURED = case_when(SEVERE_GEST_HYPER==1 | 
#                                            (M08_AST_UL_LBORRES_2 >= 90 | M08_ALT_UL_LBORRES_2 >=120| # AST AND ALT 2X THE UPPER NORMAL RANGE
#                                            (M08_CBC_PLATE_LBORRES_2 =< 100000) | 
#                                              
#                                            SERUM BILI >=1.2MG/DL OR 20.52 UMOL/l & HEMOGLOBIN <7G/DL | 
...
merged_df <- merged_df %>%  # POC FIRST (MNH06)
  mutate(MAT_INFECT_MEAS_ANC = case_when((M06_HIV_POC_LBORRES_7==1 | M06_HIV_POC_LBORRES_8==1 | M06_HIV_POC_LBORRES_9==1 | 
...
PRE_FEAT_SEV_MEAS
US_GA_WKS_AGE_FTS1
VISITS: ALL ANC AND PNC VISITS??? INCL HOSP.
...
######################################
merged_df <- merged_df %>%
  mutate(MAT_INFECTIONSEPSIS_ANY_COMPLICATIONS = case_when((MAT_INFECTIONSEPSIS_ANY_ANC==1 & MAT_SEV_COMP==1) ~ 1, # 
