...
round(prop.table(table(MAT_ANTIBX_TREAT_ANC = mnh_merged_df$MAT_ANTIBX_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)
```
...
#########################################################################
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_INFECT_DIAG_IPC_POST_DELIV = case_when(((M09_COMMUNIC_MHOCCUR_1_6==1 | M09_COMMUNIC_MHOCCUR_2_6==1 | 
                                                        M09_COMMUNIC_MHOCCUR_3_6==1 |  M09_COMMUNIC_MHOCCUR_4_6==1 | 
                                                        M09_COMMUNIC_MHOCCUR_5_6==1 | M09_COMMUNIC_MHOCCUR_9_6==1 |
                                                     ...
                                                     (M10_POST_DEL_INF_CEOCCUR_1_6==1 | M10_POST_DEL_INF_CEOCCUR_2_6==1 |
                                                        M10_POST_DEL_INF_CEOCCUR_3_6==1 | M10_POST_DEL_INF_CEOCCUR_4_6==1 |
                                                        M10_POST_DEL_INF_CEOCCUR_5_6==1 | M10_POST_DEL_INF_CEOCCUR_6_6==1 | 
                                                        M10_POST_DEL_INF_CEOCCUR_7_6==1 | M10_POST_DEL_INF_CEOCCUR_8_6==1 |
                                                        M10_POST_DEL_INF_CEOCCUR_9_6==1 | M10_POST_DEL_INF_CEOCCUR_10_6==1 |
                                                        M10_POST_DEL_INF_CEOCCUR_11_6==1 | M10_POST_DEL_INF_CEOCCUR_12_6==1 |
                                                        M10_POST_DEL_INF_CEOCCUR_13_6==1 | M10_POST_DEL_INF_CEOCCUR_14_6==1) ~1, 
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV = case_when(((M09_ADMIT_ABX_CMOCCUR_6==1 | # MADE THIS INTO AN "OR" INSTEAD OF "AND" EVENTOUGH IT SHOULD BE "AND".
                                                             ...
                                                             M09_ADMIT_ABX_CMTRT_7_6==1 | M09_ADMIT_ABX_CMTRT_8_6==1 | M09_ADMIT_ABX_CMTRT_9_6==1) &
                                                            # Indication is any of these reasons (i.e. UT, PID, dental infection, other, don't know etc):
                                                            (M09_ADMIT_ABX_CMINDC_6 %in% c(1,2,3,4,5,6,7,88,99))) ~ 1, 
...
```{r}
##########################################################################
# MATERNAL INFECTION DURING PNC - VISIT 7 - DIAGNOSED # 
#TODO
...
mnh_merged_df <- mnh_merged_df %>% # VISIT 7
  mutate(MAT_INFECT_N_SEPSIS_DIAG_PNC = case_when(M12_POST_DEL_INF_MHOCCUR_1_7==1 | M12_POST_DEL_INF_MHOCCUR_2_7==1 | M12_POST_DEL_INF_MHOCCUR_3_7==1 | 
                                                    ...
                                                    M12_POST_DEL_INF_MHOCCUR_10_7==1 | M12_POST_DEL_INF_MHOCCUR_11_7==1 ~1, #_11 is SEPSIS.
                                                    
                                                    # SARI, COVID-19, MALARIA, HIV:
                                                    (M12_SARI_CEOCCUR_7==1 | 
                                                    (M12_COVID_LBPERF_7==1 &  
                                                       (M12_COVID_FAMETHOD_7 %in% c(1,2))) | 
                                                  ...
                                                  (M12_SARI_CEOCCUR_9==1  | 
                                                      (M12_COVID_LBPERF_9==1 |   # THERE ARE A LOT OF COVID-19 IMAGINING QUESTIONS HERE - SHOULD THOSE BE ACCOUNTED FOR? 
                                                       (M12_COVID_FAMETHOD_9 %in% c(1,2))) | 
                                                      (M12_MALARIA_MHOCCUR_9==1 | 
                                                       (M12_MALARIA_FAMETHOD_9 %in% c(1,2))) | 
                                                  ...
                                                  (M12_SARI_CEOCCUR_10==1 |
                                                    (M12_COVID_LBPERF_10==1 &
                                                       (M12_COVID_FAMETHOD_10 %in% c(1,2))) | 
                                                    (M12_MALARIA_MHOCCUR_10==1 & 
                                                       (M12_MALARIA_FAMETHOD_10 %in% c(1,2))) | 
                                                    M12_HIV_MHOCCUR_10==1) ~ 1,
                                                  TRUE ~ as.numeric(0)))

table(MAT_INFECT_N_SEPSIS_DIAG_PNC = mnh_merged_df$MAT_INFECT_N_SEPSIS_DIAG_PNC, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_INFECT_N_SEPSIS_DIAG_PNC = mnh_merged_df$MAT_INFECT_N_SEPSIS_DIAG_PNC, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 2)
