...
table(SITE = mnh_merged_df$SITE, GA_BOE = mnh_merged_df$GA_BOE_WKS, useNA = "always") #SITE taken out

table(SITE = mnh_merged_df$SITE, mnh_merged_df$M01_GA_LMP_DAYS_CALC_1, useNA = "always") #SITE taken out
```
...
table(PREG_DEATH=mnh_merged_df$PREG_DEATH, SITE = mnh_merged_df$SITE, useNA = "always") # data is molsty 2=Alive or 4 = loss to follow up or NA. 
round(prop.table(table(PREG_DEATH=mnh_merged_df$PREG_DEATH, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 3)
...
round(prop.table(table(LATE_PREG_DEATH=mnh_merged_df$LATE_PREG_DEATH, SITE = mnh_merged_df$SITE, useNA = "always"))*100, 3) # data is molsty 2=Alive or 4 = loss to follow up or NA. 
```
...
# INFECTION VARS - SITES HAVEN'T STARTED USING THESE TESTS YETS - 09/20/2023
M08_SYPH_TITER_LBPERF_1_1 <- ifelse("M08_SYPH_TITER_LBPERF_1_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_SYPH_TITER_LBPERF_1_1, NA)

M08_SYPH_TITER_LBPERF_1_2 <- ifelse("M08_SYPH_TITER_LBPERF_1_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_SYPH_TITER_LBPERF_1_2, NA)

M08_SYPH_TITER_LBPERF_1_3 <- ifelse("M08_SYPH_TITER_LBPERF_1_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_SYPH_TITER_LBPERF_1_3, NA)

M08_SYPH_TITER_LBPERF_1_4 <- ifelse("M08_SYPH_TITER_LBPERF_1_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_SYPH_TITER_LBPERF_1_4, NA)

M08_SYPH_TITER_LBPERF_1_5 <- ifelse("M08_SYPH_TITER_LBPERF_1_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_SYPH_TITER_LBPERF_1_5, NA)

M08_HEV_IGM_LBORRES_1 <- ifelse("M08_HEV_IGM_LBORRES_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_HEV_IGM_LBORRES_1, NA)

M08_HEV_IGM_LBORRES_2 <- ifelse("M08_HEV_IGM_LBORRES_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_HEV_IGM_LBORRES_2, NA)

M08_HEV_IGM_LBORRES_3 <- ifelse("M08_HEV_IGM_LBORRES_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_HEV_IGM_LBORRES_3, NA)

M08_HEV_IGM_LBORRES_4 <- ifelse("M08_HEV_IGM_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_HEV_IGM_LBORRES_4, NA)

M08_HEV_IGM_LBORRES_5 <- ifelse("M08_HEV_IGM_LBORRES_5" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_HEV_IGM_LBORRES_5, NA)

M08_CTNG_CT_LBORRES_1 <- ifelse("M08_CTNG_CT_LBORRES_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_CT_LBORRES_1, NA)

M08_CTNG_CT_LBORRES_2 <- ifelse("M08_CTNG_CT_LBORRES_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_CT_LBORRES_2, NA)

M08_CTNG_CT_LBORRES_3 <- ifelse("M08_CTNG_CT_LBORRES_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_CT_LBORRES_3, NA)

M08_CTNG_CT_LBORRES_4 <- ifelse("M08_CTNG_CT_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_CT_LBORRES_4, NA)

M08_CTNG_CT_LBORRES_5 <- ifelse("M08_CTNG_CT_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_CT_LBORRES_5, NA)

M08_CTNG_NG_LBORRES_1 <- ifelse("M08_CTNG_NG_LBORRES_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_NG_LBORRES_1, NA)

M08_CTNG_NG_LBORRES_2 <- ifelse("M08_CTNG_NG_LBORRES_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_NG_LBORRES_2, NA)

M08_CTNG_NG_LBORRES_3 <- ifelse("M08_CTNG_NG_LBORRES_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_NG_LBORRES_3, NA)

M08_CTNG_NG_LBORRES_4 <- ifelse("M08_CTNG_NG_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_NG_LBORRES_4, NA)

M08_CTNG_NG_LBORRES_5 <- ifelse("M08_CTNG_NG_LBORRES_5" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_CTNG_NG_LBORRES_5, NA)

M08_ZCD_ZIKIGM_LBORRES_1 <- ifelse("M08_ZCD_ZIKIGM_LBORRES_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_ZIKIGM_LBORRES_1, NA)

M08_ZCD_ZIKIGM_LBORRES_2 <- ifelse("M08_ZCD_ZIKIGM_LBORRES_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_ZIKIGM_LBORRES_2, NA)

M08_ZCD_ZIKIGM_LBORRES_3 <- ifelse("M08_ZCD_ZIKIGM_LBORRES_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_ZIKIGM_LBORRES_3, NA)

M08_ZCD_ZIKIGM_LBORRES_4 <- ifelse("M08_ZCD_ZIKIGM_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_ZIKIGM_LBORRES_4, NA)

M08_ZCD_ZIKIGM_LBORRES_5 <- ifelse("M08_ZCD_ZIKIGM_LBORRES_5" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_ZIKIGM_LBORRES_5, NA)

M08_ZCD_CHKIGM_LBORRES_1 <- ifelse("M08_ZCD_CHKIGM_LBORRES_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_CHKIGM_LBORRES_1, NA)

M08_ZCD_CHKIGM_LBORRES_2 <- ifelse("M08_ZCD_CHKIGM_LBORRES_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_CHKIGM_LBORRES_2, NA)

M08_ZCD_CHKIGM_LBORRES_3 <- ifelse("M08_ZCD_CHKIGM_LBORRES_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_CHKIGM_LBORRES_3, NA)

M08_ZCD_CHKIGM_LBORRES_4 <- ifelse("M08_ZCD_CHKIGM_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_CHKIGM_LBORRES_4, NA)

M08_ZCD_CHKIGM_LBORRES_5 <- ifelse("M08_ZCD_CHKIGM_LBORRES_5" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_CHKIGM_LBORRES_5, NA)

M08_ZCD_DENIGM_LBORRES_1 <- ifelse("M08_ZCD_DENIGM_LBORRES_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_DENIGM_LBORRES_1, NA)

M08_ZCD_DENIGM_LBORRES_2 <- ifelse("M08_ZCD_DENIGM_LBORRES_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_DENIGM_LBORRES_2, NA)

M08_ZCD_DENIGM_LBORRES_3 <- ifelse("M08_ZCD_DENIGM_LBORRES_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_DENIGM_LBORRES_3, NA)

M08_ZCD_DENIGM_LBORRES_4 <- ifelse("M08_ZCD_DENIGM_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_DENIGM_LBORRES_4, NA)

M08_ZCD_DENIGM_LBORRES_5 <- ifelse("M08_ZCD_DENIGM_LBORRES_5" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_ZCD_DENIGM_LBORRES_5, NA)

M08_LEPT_IGM_LBORRES_1 <- ifelse("M08_LEPT_IGM_LBORRES_1" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_LEPT_IGM_LBORRES_1, NA)

M08_LEPT_IGM_LBORRES_2 <- ifelse("M08_LEPT_IGM_LBORRES_2" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_LEPT_IGM_LBORRES_2, NA)

M08_LEPT_IGM_LBORRES_3 <- ifelse("M08_LEPT_IGM_LBORRES_3" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_LEPT_IGM_LBORRES_3, NA)

M08_LEPT_IGM_LBORRES_4 <- ifelse("M08_LEPT_IGM_LBORRES_4" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_LEPT_IGM_LBORRES_4, NA)

M08_LEPT_IGM_LBORRES_5 <- ifelse("M08_LEPT_IGM_LBORRES_5" %in% names(mnh_merged_df),
                                            mnh_merged_df$M08_LEPT_IGM_LBORRES_5, NA)
...
table(MAT_ANEMIA_MEAS1 = mnh_merged_df$MAT_ANEMIA_MEAS1, useNA = "always", SITE = mnh_merged_df$SITE)
...
table(mnh_merged_df$MAT_ANEMIA_MEAS_ANC, useNA = "always", mnh_merged_df$SITE)
round(prop.table(table(mnh_merged_df$MAT_ANEMIA_MEAS_ANC, useNA = "always", mnh_merged_df$SITE), margin = 2)*100, 3)
...
round(prop.table(table(mnh_merged_df$MAT_ANEMIA_MEAS6, useNA = "always", mnh_merged_df$SITE), margin = 2)*100, 2)
################################# NOTE ##################################################
...
round(prop.table(table(mnh_merged_df$MAT_ANEMIA_MEAS10, useNA = "always", mnh_merged_df$SITE), margin = 2)*100, 2)
...
round(prop.table(table(mnh_merged_df$MAT_ANEMIA_MEAS11, useNA = "always", mnh_merged_df$SITE), margin = 2)*100, 2)
...
round(prop.table(table(mnh_merged_df$MAT_ANEMIA_MEAS_ANY, mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 3)
```
...
mnh_merged_df <- mnh_merged_df %>% #'any' is checking if anything in these columns by row(dplyr is doing the by-row part) is NA.
...
#table(mnh_merged_df$MAT_DEATH)
table(MAT_DEATH = mnh_merged_df$MAT_DEATH, SITE = mnh_merged_df$SITE) # data is molsty 2=Alive or 4 = loss to follow up or NA.
round(prop.table(table(MAT_DEATH = mnh_merged_df$MAT_DEATH, SITE = mnh_merged_df$SITE), margin=2)*100, 2) # data is molsty 2=Alive or 4 = loss to follow up or NA. 
```
...
round(prop.table(table(CRITICAL_INTERVENTIONS = mnh_merged_df$MAT_INTER_LnD, SITE = mnh_merged_df$SITE, useNA = "always"), margin = 2)*100, 2)
...
table(PRETERM_SPON = mnh_merged_df$PRETERM_SPON, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(PRETERM_SPON = mnh_merged_df$PRETERM_SPON, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 2)
...
table(PRETERM_PROV = mnh_merged_df$PRETERM_PROV, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(PRETERM_PROV = mnh_merged_df$PRETERM_PROV, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 2)
...
table(PPROM_OCCUR = mnh_merged_df$PPROM_OCCUR, SITE = mnh_merged_df$SITE, useNA = "always")

round(prop.table(table(PPROM_OCCUR = mnh_merged_df$PPROM_OCCUR, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 2)
...
table(ANY_PTB = mnh_merged_df$PRETERM_ANY, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(ANY_PTB = mnh_merged_df$PRETERM_ANY, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 2)
```
...
table(PLACENTA_PREVIA = mnh_merged_df$PLACENTA_PREVIA, useNA = "always")
```
...
table(MAT_UTERINE_RUPTURE = mnh_merged_df$MAT_UTER_RUP, SITE= mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_UTERINE_RUPTURE = mnh_merged_df$MAT_UTER_RUP, SITE= mnh_merged_df$SITE, useNA = "always"), margin = 2)*100, 2)
```
...
table(LATE_MAT_DEATH = mnh_merged_df$LATE_MAT_DEATH, SITE = mnh_merged_df$SITE, useNA = "always") 
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(CHRON_HYPER = case_when((meanSBP_ANC_LT20 >=140 | meanDBP_ANC_LT20 >=90)  ~ 1, 
                                     TRUE  ~ as.numeric(0)))
table(mnh_merged_df$CHRON_HYPER, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(mnh_merged_df$CHRON_HYPER, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 2)
```
...
table(GEST_HYPER_MEAS = mnh_merged_df$GEST_HYPER_MEAS, SITE=mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(GEST_HYPER_MEAS = mnh_merged_df$GEST_HYPER_MEAS, SITE=mnh_merged_df$SITE, useNA = "always"),margin=2)*100,2)
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(SEVERE_GEST_HYPER = case_when(CHRON_HYPER==0 &((meanSBP_ANC20 >=160 | meanDBP_ANC20 >=110 |
                                     ...
                                     TRUE  ~ as.numeric(0)))
table(SEVERE_GEST_HYPER = mnh_merged_df$SEVERE_GEST_HYPER, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(SEVERE_GEST_HYPER = mnh_merged_df$SEVERE_GEST_HYPER, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)
...
table(HYPER_PNC_MEAS = mnh_merged_df$HYPER_PNC_MEAS, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(HYPER_PNC_MEAS = mnh_merged_df$HYPER_PNC_MEAS, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)
```
...
table(GEST_HYPER_DIAG = mnh_merged_df$GEST_HYPER_DIAG, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(GEST_HYPER_DIAG = mnh_merged_df$GEST_HYPER_DIAG, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)
```
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(SEVERE_GEST_HYPER_REP = case_when(M09_HDP_HTN_MHOCCUR_3_6==1 & M09_PREECLAMPSIA_CEOCCUR_3_6==1 ~ 1,
                                           M19_HDP_HTN_MHOCCUR_3_13==1 & M19_PREECLAMPSIA_CEOCCUR_3_13==1 ~ 1,
                                           TRUE ~ as.numeric(0)))
table(SEVERE_GEST_HYPER_REP = mnh_merged_df$SEVERE_GEST_HYPER_REP, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(SEVERE_GEST_HYPER_REP = mnh_merged_df$SEVERE_GEST_HYPER_REP, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)
```
...
table(MAT_DYS = mnh_merged_df$MAT_DYS, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_DYS = mnh_merged_df$MAT_DYS, SITE = mnh_merged_df$SITE, useNA = "always"),margin=2)*100,2)
```
...
table(PRE_DIAG = mnh_merged_df$PRE_DIAG, useNA = "always")
```
...
temp.df <- mnh_merged_df %>% select(MOMID, PREGID, SITE, M06_BGLUC_POC_MMOLL_LBORRES_2, 
                                    M08_BGLUC_PRETEST_MMOLL_LBORRES_1, M08_BGLUC_PRETEST_MMOLL_LBORRES_2, M08_BGLUC_PRETEST_MMOLL_LBORRES_3,
                                    M08_HBA1C_LBORRES_1)
tapply(mnh_merged_df$M08_HBA1C_LBORRES_1, mnh_merged_df$SITE, summary)
...
table(GEST_DIAB_DIAG = mnh_merged_df$GEST_DIAB_DIAG, SITE = mnh_merged_df$SITE, useNA = "always")
table(GEST_DIAB_MEAS = mnh_merged_df$GEST_DIAB_MEAS, SITE = mnh_merged_df$SITE, useNA = "always")
...
table(MAT_APH = mnh_merged_df$MAT_APH, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_APH = mnh_merged_df$MAT_APH, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)
```
...
table(MAT_PPH = mnh_merged_df$MAT_PPH, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_PPH = mnh_merged_df$MAT_PPH, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)


table(MAT_PPH_LATE = mnh_merged_df$MAT_PPH_LATE, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_PPH_LATE = mnh_merged_df$MAT_PPH_LATE, SITE = mnh_merged_df$SITE, useNA = "always"),margin=2)*100, 2)

table(MAT_PPH_SEV = mnh_merged_df$MAT_PPH_SEV, SITE = mnh_merged_df$SITE, useNA = "always") #TODO LYNDA HAS N=5
round(prop.table(table(MAT_PPH_SEV = mnh_merged_df$MAT_PPH_SEV, SITE = mnh_merged_df$SITE, useNA = "always"),margin=2)*100, 2)
...
mnh_merged_df$LABOR_DATE_TIME <- format(as.POSIXct(mnh_merged_df$LABOR_DATE_TIME, format="%Y-%m-%d %H:%M"))

mnh_merged_df$DELIV_DATE_TIME <- format(as.POSIXct(mnh_merged_df$DELIV_DATE_TIME, format="%Y-%m-%d %H:%M"))
...
table(PRO_LABOR = mnh_merged_df$PRO_LABOR, useNA = "always")
```
...
***MAT_SEPSIS_DIAG_ANC*** = infection and organ dysfuction. 
```{r}
#################################################################################
#TODO 
# NOTES: 
...
# LOOK OVER SEPSIS AGAIN. 
# - NEED TO INCLUDE HOSPITALIZATION DURING ANC (MNH19) -AS IT'S OWN SECTION? SEE SLIDE 92
...
# ----But for all the other timepoints, it doesn't matter what the indcation is, just say INFECTION = YES if they are taking medication.
##################################################################################
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_INFECT_DIAG_ANC = case_when(M04_HIV_CMOCCUR_1==1 | M04_HIV_CMOCCUR_2==1 | M04_HIV_CMOCCUR_3==1 | 
...
table(MAT_INFECT_DIAG_ANC = mnh_merged_df$MAT_INFECT_DIAG_ANC, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_INFECT_DIAG_ANC = mnh_merged_df$MAT_INFECT_DIAG_ANC, SITE = mnh_merged_df$SITE, useNA = "always"),margin=2)*100,2)
...
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_INFECT_SEPSIS_DIAG_ANC = case_when(MAT_DYS==1 | MAT_INFECT_DIAG_ANC==1 ~ 1, 
                                         TRUE ~ as.numeric(0)))
table(mnh_merged_df$MAT_INFECT_SEPSIS_DIAG_ANC, SITE= mnh_merged_df$SITE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_SYPH_INFECT_TREAT_ANC = case_when(M04_SYPH_CMTRT_1_1==1 | M04_SYPH_CMTRT_1_2==1 | M04_SYPH_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_SYPH_INFECT_TREAT_ANC = mnh_merged_df$MAT_SYPH_INFECT_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_GONORRHEA_INFECT_TREAT_ANC = case_when(M04_GONORRHEA_CMTRT_1_1==1 | M04_GONORRHEA_CMTRT_1_2==1 | M04_GONORRHEA_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_GONORRHEA_INFECT_TREAT_ANC = mnh_merged_df$MAT_GONORRHEA_INFECT_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_CHLAMYDIA_INFECT_TREAT_ANC = case_when(M04_CHLAMYDIA_CMTRT_1_1==1 | M04_CHLAMYDIA_CMTRT_1_2==1 | M04_CHLAMYDIA_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_CHLAMYDIA_INFECT_TREAT_ANC = mnh_merged_df$MAT_CHLAMYDIA_INFECT_TREAT_ANC, SITE = mnh_merged_df$SITE,useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_CHANC_INFECT_TREAT_ANC = case_when(M04_CHANC_CMTRT_1_1==1 | M04_CHANC_CMTRT_1_2==1 | M04_CHANC_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_CHANC_INFECT_TREAT_ANC = mnh_merged_df$MAT_CHANC_INFECT_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_STI_OTHR_INFECT_TREAT_ANC = case_when(M04_STI_OTHR_CMOCCUR_1==1 | M04_STI_OTHR_CMOCCUR_2==1 | M04_STI_OTHR_CMOCCUR_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_STI_OTHR_INFECT_TREAT_ANC = mnh_merged_df$MAT_STI_OTHR_INFECT_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_MALARIA_INFECT_TREAT_ANC = case_when(M04_MALARIA_EVER_CMTRT_1_1==1 | M04_MALARIA_EVER_CMTRT_1_2==1 | M04_MALARIA_EVER_CMTRT_1_3==1 |
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_MALARIA_INFECT_TREAT_ANC = mnh_merged_df$MAT_MALARIA_INFECT_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_TB_INFECT_TREAT_ANC = case_when(M04_TB_CMTRT_1_1==1 | M04_TB_CMTRT_1_2==1 | M04_TB_CMTRT_1_3==1 | 
                                            ...
                                            TRUE ~ as.numeric(0)))
table(MAT_TB_INFECT_TREAT_ANC = mnh_merged_df$MAT_TB_INFECT_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always")
...
mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_ANTIBX_TREAT_ANC = case_when(M04_ANTIBX_CMOCCUR_1==1 | M04_ANTIBX_CMOCCUR_2==1 | M04_ANTIBX_CMOCCUR_3==1 |
                                            ...
                                            # ANY OF THESE MEDS DURING ANCE 1-5:
                                            # VISIT 1
                                            M04_ANTIBX_CMINDC_1==1 | M04_ANTIBX_CMINDC_1==2 | M04_ANTIBX_CMINDC_1==3 | 
                                            M04_ANTIBX_CMINDC_1==4 | M04_ANTIBX_CMINDC_1==5| M04_ANTIBX_CMINDC_1==6 | 
                                            M04_ANTIBX_CMINDC_1==7 | M04_ANTIBX_CMINDC_1==8 | M04_ANTIBX_CMINDC_1==9 | 
                                            M04_ANTIBX_CMINDC_1==88 | # DISCUSSED WITH ERS - INCLUDE "OTHER = 88" TRT.
                                            
                                            # VISIT 2
                                            M04_ANTIBX_CMINDC_2==1 | M04_ANTIBX_CMINDC_2==2 | M04_ANTIBX_CMINDC_2==3 | 
                                            M04_ANTIBX_CMINDC_2==4 | M04_ANTIBX_CMINDC_2==5 | M04_ANTIBX_CMINDC_2==6 | 
                                            M04_ANTIBX_CMINDC_2==7 | M04_ANTIBX_CMINDC_2==8 | # M04_ANTIBX_CMINDC_2==9 | 
                                            M04_ANTIBX_CMINDC_2==88 | 
                                            
                                            # VISIT 3
                                            M04_ANTIBX_CMINDC_3==1 | M04_ANTIBX_CMINDC_3==2 | M04_ANTIBX_CMINDC_3==3 | 
                                            M04_ANTIBX_CMINDC_3==4 | M04_ANTIBX_CMINDC_3==5 | M04_ANTIBX_CMINDC_3==6 | 
                                            M04_ANTIBX_CMINDC_3==7 | M04_ANTIBX_CMINDC_3==8 | # M04_ANTIBX_CMINDC_3==9 | 
                                            M04_ANTIBX_CMINDC_3==88 | 
                                            
                                            # VISIT 4
                                            M04_ANTIBX_CMINDC_4==1 | M04_ANTIBX_CMINDC_4==2 | M04_ANTIBX_CMINDC_4==3 | 
                                            M04_ANTIBX_CMINDC_4==4 | M04_ANTIBX_CMINDC_4==5 | M04_ANTIBX_CMINDC_4==6 | 
                                            M04_ANTIBX_CMINDC_4==7 | M04_ANTIBX_CMINDC_4==8 | # M04_ANTIBX_CMINDC_4==9 | # DISCUSSED WITH ERS - DONT' INCLUDE PROPHYLAXIS TRT
                                            M04_ANTIBX_CMINDC_4==88 | 
                                            
                                            # VISIT 5
                                            M04_ANTIBX_CMINDC_5==1 | M04_ANTIBX_CMINDC_5==2 | M04_ANTIBX_CMINDC_5==3 | 
                                            M04_ANTIBX_CMINDC_5==4 | M04_ANTIBX_CMINDC_5==5 | M04_ANTIBX_CMINDC_5==6 | 
                                            M04_ANTIBX_CMINDC_5==7 | M04_ANTIBX_CMINDC_5==8 | M04_ANTIBX_CMINDC_5==9 | 
                                            M04_ANTIBX_CMINDC_5==88 | 
                                            
                                            # VISIT 13 - UNSCHEDULED ANC
                                            M04_ANTIBX_CMINDC_13==1 | M04_ANTIBX_CMINDC_13==2 | M04_ANTIBX_CMINDC_13==3 | 
                                            M04_ANTIBX_CMINDC_13==4 | M04_ANTIBX_CMINDC_13==5 | M04_ANTIBX_CMINDC_13==6 | 
                                            M04_ANTIBX_CMINDC_13==7 | M04_ANTIBX_CMINDC_13==8 | M04_ANTIBX_CMINDC_13==9 | 
                                            M04_ANTIBX_CMINDC_13==88  ~ 1, 
                                          TRUE ~ as.numeric(0)))
table(MAT_ANTIBX_TREAT_ANC = mnh_merged_df$MAT_ANTIBX_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always")

mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_INFECT_DIAG_TREAT_ANC = case_when(MAT_CHANC_INFECT_TREAT_ANC ==1 | MAT_CHLAMYDIA_INFECT_TREAT_ANC==1 |
...
round(prop.table(table(mnh_merged_df$MAT_INFECT_DIAG_TREAT_ANC, SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100, 2)
###########################################################################
# MATERNAL INFECTION MEASURED THROUGH POC MNH06 and LAB MNH06 - ANC ONLY #
##########################################################################

mnh_merged_df <- mnh_merged_df %>%  # POC FIRST (MNH06)
  mutate(MAT_INFECT_MEAS_POC_LAB_ANC = case_when((M06_HIV_POC_LBORRES_1==1 | M06_HIV_POC_LBORRES_2==1 | M06_HIV_POC_LBORRES_3==1 | 
                                                 ...
                                                 TRUE ~ as.numeric(0)))
table(MAT_INFECT_MEAS_POC_LAB_ANC = mnh_merged_df$MAT_INFECT_MEAS_POC_LAB_ANC, SITE= mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_INFECT_MEAS_POC_LAB_ANC = mnh_merged_df$MAT_INFECT_MEAS_POC_LAB_ANC, SITE= mnh_merged_df$SITE,  useNA = "always"),
                 margin=2)*100,2)

```

***SECONDARY: MATERNAL INFECTION AND SEPSIS (PREGNANCY) - L&D VISIT***
```{r}
##########################################################################
# MATERNAL INFECTION DURING L&D AND POST-DELIVERY - VISIT 6 - DIAGNOSED # 
#TODO
# - SHOULD "OTHER" BE INCLUDED HERE? 
#########################################################################
mnh_merged_df <- mnh_merged_df %>% 
  mutate(MAT_INFECT_DIAG_IPC_POST_DELIV = case_when((M09_COMMUNIC_MHOCCUR_1_6==1 | M09_COMMUNIC_MHOCCUR_2_6==1 | M09_COMMUNIC_MHOCCUR_3_6==1 | 
                                           M09_COMMUNIC_MHOCCUR_4_6==1 | M09_COMMUNIC_MHOCCUR_5_6==1 | M09_COMMUNIC_MHOCCUR_9_6==1 |
                                           M09_COMMUNIC_MHOCCUR_10_6==1 |
                                           M09_INFECT_MHOCCUR_1_6==1 | M09_INFECT_MHOCCUR_2_6==1 | M09_INFECT_MHOCCUR_3_6==1 | 
                                           M09_INFECT_MHOCCUR_4_6==1 | M09_INFECT_MHOCCUR_5_6==1 | M09_INFECT_MHOCCUR_6_6==1 |
                                           M09_INFECT_MHOCCUR_7_6==1 | M09_INFECT_MHOCCUR_8_6==1 | M09_INFECT_MHOCCUR_9_6==1 |
                                           M09_INFECT_MHOCCUR_10_6==1) & (M09_INFECT_SRCE_2_6==1 | M09_INFECT_SRCE_3_6==1) ~ 1,
                                           (M10_POST_DEL_INF_CEOCCUR_1_6==1 | M10_POST_DEL_INF_CEOCCUR_2_6==1 | M10_POST_DEL_INF_CEOCCUR_3_6==1 |
                                             M10_POST_DEL_INF_CEOCCUR_4_6==1 | M10_POST_DEL_INF_CEOCCUR_5_6==1 | M10_POST_DEL_INF_CEOCCUR_6_6==1 | 
                                             M10_POST_DEL_INF_CEOCCUR_7_6==1 | M10_POST_DEL_INF_CEOCCUR_8_6==1 | M10_POST_DEL_INF_CEOCCUR_9_6==1 |
                                             M10_POST_DEL_INF_CEOCCUR_10_6==1 | M10_POST_DEL_INF_CEOCCUR_11_6==1 | M10_POST_DEL_INF_CEOCCUR_12_6==1 |
                                             M10_POST_DEL_INF_CEOCCUR_13_6==1 | M10_POST_DEL_INF_CEOCCUR_14_6==1) ~1, # | M10_POST_DEL_INF_CEOCCUR_88_6==1 |
                                         TRUE ~ as.numeric(0)))
table(MAT_INFECT_DIAG_IPC_POST_DELIV = mnh_merged_df$MAT_INFECT_DIAG_IPC_POST_DELIV, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_INFECT_DIAG_IPC_POST_DELIV = mnh_merged_df$MAT_INFECT_DIAG_IPC_POST_DELIV, SITE = mnh_merged_df$SITE, useNA = "always"),
                 margin=2)*100,2)
#######################################################
# MATERNAL INFECTION DURING L&D - VISIT 6 - MEASURED # 
# NOTE: THERE IS NO 'MEASURED' AT IPC.
#######################################################

#############################################################
# MATERNAL INFECTION ***TREATMENT*** DURING L&D - VISIT 6  # 
# - SHOULD "OTHER" BE ADDED HERE? 
#############################################################

mnh_merged_df <- mnh_merged_df %>%
  mutate(MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV = case_when(M09_ADMIT_ABX_CMOCCUR_6==1 | # MADE THIS INTO AN "OR" INSTEAD OF "AND" EVENTOUGH IT SHOULD BE "AND".
                                                            M09_ADMIT_ABX_CMTRT_1_6==1 | M09_ADMIT_ABX_CMTRT_2_6==1 | M09_ADMIT_ABX_CMTRT_3_6==1 |
                                                            M09_ADMIT_ABX_CMTRT_4_6==1 | M09_ADMIT_ABX_CMTRT_5_6==1 | M09_ADMIT_ABX_CMTRT_6_6==1 |
                                                            M09_ADMIT_ABX_CMTRT_7_6==1 | M09_ADMIT_ABX_CMTRT_8_6==1 | M09_ADMIT_ABX_CMTRT_9_6==1 ~ 1, 
                                                          # M09_ADMIT_ABX_CMTRT_88==1
                                                          
                                                          # POST DELIVERY:
                                                          (M10_LD_ABX_CMOCCUR_1_6==1 | M10_LD_ABX_CMOCCUR_2_6==1 | M10_LD_ABX_CMOCCUR_3_6==1 | 
                                                            M10_LD_ABX_CMOCCUR_4_6==1 | M10_LD_ABX_CMOCCUR_5_6==1 | M10_LD_ABX_CMOCCUR_6_6==1 | 
                                                            M10_LD_ABX_CMOCCUR_7_6==1) ~ 1, # | M10_LD_ABX_CMOCCUR_88_6==1
                                                          TRUE ~ as.numeric(0)))

table(MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV = mnh_merged_df$MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV, SITE = mnh_merged_df$SITE, useNA = "always")
round(prop.table(table(MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV = mnh_merged_df$MAT_SYPH_INFECT_TREAT_IPC_POST_DELIV, 
                       SITE = mnh_merged_df$SITE, useNA = "always"), margin=2)*100,2)
```

***SECONDARY: MATERNAL INFECTION AND SEPSIS (PREGNANCY) - PNC VISIT***
USE MNH06 PNC6, PNC1, PNC4, PNC6 (VISITS 7-10)
```{r}
##########################################################################
# MATERNAL INFECTION DURING L&D AND POST-DELIVERY - VISIT 6 - DIAGNOSED # 
#TODO
# - SHOULD "OTHER" BE INCLUDED HERE? 
# - SHOULD COVID_FAMETHOD = 1 OR 2 BE INCLUDED? 
#########################################################################
...
mnh_merged_df <- mnh_merged_df %>% # VISIT 7
  mutate(MAT_INFECT_N_SEPSIS_DIAG_PNC = case_when(M12_POST_DEL_INF_MHOCCUR_1_7==1 | M12_POST_DEL_INF_MHOCCUR_2_7==1 | M12_POST_DEL_INF_MHOCCUR_3_7==1 | 
                                                    M12_POST_DEL_INF_MHOCCUR_4_7==1 | M12_POST_DEL_INF_MHOCCUR_5_7==1 | M12_POST_DEL_INF_MHOCCUR_6_7==1 | 
                                                    M12_POST_DEL_INF_MHOCCUR_7_7==1 | M12_POST_DEL_INF_MHOCCUR_8_7==1 | M12_POST_DEL_INF_MHOCCUR_9_7==1 |
                                                    M12_POST_DEL_INF_MHOCCUR_10_7==1 | M12_POST_DEL_INF_MHOCCUR_11_7==1 | #_11 is SEPSIS.
                                                    
                                                    # SARI, COVID-19, MALARIA, HIV:
                                                    (M12_SARI_CEOCCUR_7==1 | !is.na(M12_SARI_CESTDAT_7)) |
                                                    (M12_COVID_LBPERF_7==1 | !is.na(M12_COVID_LBDAT_7) | 
                                                       (M12_COVID_FAMETHOD_7==1 | M12_COVID_FAMETHOD_7==2)) | 
                                                    (M12_MALARIA_MHOCCUR_7==1 | !is.na(M12_MALARIA_MHSTDAT_7) | 
                                                       (M12_MALARIA_FAMETHOD_7==1 | M12_MALARIA_FAMETHOD_7==2))| 
                                                    (M12_HIV_MHOCCUR_7==1 | !is.na(M12_HIV_MHSTDAT_7)) ~ 1,
                                                  ...
                                                  # SARI, COVID-19, MALARIA, HIV:
                                                  ((M12_SARI_CEOCCUR_8==1 | !is.na(M12_SARI_CESTDAT_8)) |
                                                    (M12_COVID_LBPERF_8==1 | !is.na(M12_COVID_LBDAT_8) | 
                                                       (M12_COVID_FAMETHOD_8==1 | M12_COVID_FAMETHOD_8==2)) | 
                                                    (M12_MALARIA_MHOCCUR_8==1 | !is.na(M12_MALARIA_MHSTDAT_8) | 
                                                       (M12_MALARIA_FAMETHOD_8==1 | M12_MALARIA_FAMETHOD_8==2)) | 
                                                    (M12_HIV_MHOCCUR_8==1 | !is.na(M12_HIV_MHSTDAT_8))) ~ 1,
                                                  ...
                                                  # SARI, COVID-19, MALARIA, HIV:
                                                  ((M12_SARI_CEOCCUR_9==1 | !is.na(M12_SARI_CESTDAT_9)) |
                                                    (M12_COVID_LBPERF_9==1 | !is.na(M12_COVID_LBDAT_9) | 
                                                       (M12_COVID_FAMETHOD_9==1 | M12_COVID_FAMETHOD_9==2)) | 
                                                    (M12_MALARIA_MHOCCUR_9==1 | !is.na(M12_MALARIA_MHSTDAT_9) | 
                                                       (M12_MALARIA_FAMETHOD_9==1 | M12_MALARIA_FAMETHOD_9==2)) | 
                                                    (M12_HIV_MHOCCUR_9==1 | !is.na(M12_HIV_MHSTDAT_9))) ~ 1,
                                                  ...
                                                  # SARI, COVID-19, MALARIA, HIV:
                                                  ((M12_SARI_CEOCCUR_10==1 | !is.na(M12_SARI_CESTDAT_10)) |
                                                    (M12_COVID_LBPERF_10==1 | !is.na(M12_COVID_LBDAT_10) | 
                                                       (M12_COVID_FAMETHOD_10==1 | M12_COVID_FAMETHOD_10==2)) | 
                                                    (M12_MALARIA_MHOCCUR_10==1 | !is.na(M12_MALARIA_MHSTDAT_10) | 
                                                       (M12_MALARIA_FAMETHOD_10==1 | M12_MALARIA_FAMETHOD_10==2)) | 
                                                    (M12_HIV_MHOCCUR_10==1 | !is.na(M12_HIV_MHSTDAT_10))) ~ 1,
                                                  TRUE ~ as.numeric(0)))

table(MAT_INFECT_N_SEPSIS_DIAG_PNC = mnh_merged_df$MAT_INFECT_N_SEPSIS_DIAG_PNC, useNA = "always")
